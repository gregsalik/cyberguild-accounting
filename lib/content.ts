...
export const CONTENT: Record<Audience, SiteContent> = {
  business: {
    ...
    services: [
      ...
      { icon: 'doc',     title: 'VAT, Corporation Tax, Self Assessment & Statutory Accounts', desc: 'VAT returns filed under Making Tax Digital, Corporation Tax, and Self Assessment — coordinated with your books all year, not just before the deadline. Includes year-end statutory annual accounts preparation and confirmation statements filed with Companies House. UK entities only for all tax and statutory services.' },
    ...
    tiers: [
      { entry: '001', name: 'Essentials', price: 'Monthly bookkeeping', features: ['Transaction categorisation & coding', 'Monthly bank & card reconciliation', 'Monthly P&L, balance sheet & cash flow statement'], cta: 'Get a quote' },
      ...
      { entry: '003', name: 'Full Ledger', price: 'Adds tax & advisory', features: ['Everything in Managed', 'UK tax filing — VAT, Corporation Tax & Self Assessment', 'Statutory accounts, confirmation statement & Companies House', 'Fractional CFO check-ins'], cta: 'Get a quote' },
    ],
    ...
    faq: [
      ...
      { q: 'Do US and Canadian entities receive the full service?', a: "Bookkeeping and payroll are available for US and Canadian entities. Tax filing — VAT, Corporation Tax, Self Assessment, and Companies House — is currently UK only. If you operate across borders, we handle the full scope on the UK side and books and payroll on the international side." },
  ...
  firm: {
    ...
    tiers: [
      { entry: '001', name: 'Project Capacity', price: 'Per-project or seasonal capacity', features: ['One-off catch-up & cleanup projects', 'Busy-season bookkeeping & payroll overflow', 'No minimum commitment', 'Tax return & VAT prep support: see White-Label Team tier'], cta: 'Ask about this tier' },
    ...
    faq: [
      ...
      { q: 'What if we need extra capacity mid-tax-season?',              a: "That's exactly what the Project Capacity tier exists for. We can bring on a batch of client files with a shorter onboarding window when the alternative is your own team burning out." },
      ...
      { q: 'Do you handle US and Canadian client files?',                 a: "Yes. Bookkeeping and payroll production is available for US and Canadian client files. Tax return and VAT-equivalent preparation is currently UK only — for US/Canadian files we produce books and payroll only." },
